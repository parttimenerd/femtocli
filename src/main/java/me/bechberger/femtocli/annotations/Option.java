...
public @interface Option {
    ...
    /**
     * Whether FemtoCli should automatically append the default value to the rendered help text
     ...
     *
     * <p>If empty, FemtoCli uses the global template from {@link CommandConfig}.
