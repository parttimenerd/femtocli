...
class SpecInjectionTest {
    ...
    void specIsInjectedAndUsable() {
        var cmd = new SpecCmd();
        RunResult res = MiniCli.builder().runCaptured(cmd, "--x", "5");
    ...
    void specInjectionIsSafeUnderSynchronizedConcurrentRuns() throws Exception {
        ...
        RunResult r1 = MiniCli.builder().runCaptured(new SpecSyncCmd());
        RunResult r2 = MiniCli.builder().runCaptured(new SpecSyncCmd());
